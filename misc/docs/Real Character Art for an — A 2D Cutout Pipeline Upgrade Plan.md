...
- **Rhubarb mouth shapes are a *style*, not a model.** All 9 shapes are in the public domain (originally Hanna-Barbera's set, per Daniel Wolf's README) [2], but specific drawings of them by GraphicMama or other vendors are licensed.
