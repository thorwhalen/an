...
- `an character mouths <name> [--variants happy,sad]` — regenerate the 9-shape default mouth set and its `viseme@<form>` variants (declared in the descriptor) (`mouth_a` … `mouth_x`).
