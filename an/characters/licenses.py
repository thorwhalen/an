...
DICEBEAR_STYLE_LICENSES: dict[str, StyleLicense] = {
    ...
    "dylan": StyleLicense(
        ...
        CC_BY_URL,
        "Natalia Spivak",
        "https://nataspvk.tilda.ws/",
        "Dylan! The Avatar Generator",
        "https://www.figma.com/community/file/1356575240759683500",
    ),
    "toon-head": StyleLicense(
        CC_BY,
        CC_BY_URL,
        "Johan Melin",
        "https://www.johanmelin.com",
        "ToonHead",
        "https://www.figma.com/community/file/1589627891082866389",
    ),
